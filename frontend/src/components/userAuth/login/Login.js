...
const Login = () => {
    ...
    return (
        <div className='h-screen w-full flex bg-cutom-white'>
            <div className='md:w-[50%] min-h-screen relative md:block hidden'><img src={logo} alt="loading" className=' mt-14 ml-14 bg-no-repeat bg-contain' />
            ...
            <div className='md:w-[50%] w-full min-h-screen relative bg-black flex justify-center items-center'>

                {
                    isActive ? (
                        <>
                            <div className='md:absolute md:top-[20%] md:left-[-13.5%] hidden md:block '>
                            ...
                            <div className='w-full animate-pop-up'>
                                ...
                                <div className='md:w-[450px] md:h-[400px] w-[300px] h-[250px] absolute md:top-[20%] md:left-[25%] top-4 left-0 border-2 border-opacity-50 border-black rounded-xl backdrop-blur-xl bg-transparent text-white flex flex-col  '>
                                    ...
                                    <div className='w-[85%] mx-auto px-4 py-2 mt-6 rounded-lg text-center text-xl bg-gradient-to-r from-cyan-500 to-blue-500  '>
