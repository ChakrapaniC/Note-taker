                                ...
                                <div className='sm:w-[450px]  w-[350px] h-auto absolute top-[17%] lg:top-[20%] sm:left-[25%]  left-5 border-2 border-opacity-50 border-white rounded-xl backdrop-blur-xl text-black bg-transparent md:text-white flex flex-col  '>
                                    ...
                                    <form onSubmit={formik.handleSubmit}>
                                        <div className=' w-[85%] mx-auto'>
                                            ...
                                            <input type="email" id='email' name='email' placeholder='enter your email..' value={formik.values.email} onChange={formik.handleChange} onBlur={formik.handleBlur} className='w-full rounded-xl h-[40px] outline-none text-black font-semibold px-2' />
