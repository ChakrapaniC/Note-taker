        ...
        <>
            {
                grid ?
                    <div className='flex justify-center items-center flex-col mx-auto md:mx-0 md:flex-row md:justify-normal  animate-pop-up '>
                        ...
                        <div className={`flex flex-col w-[90%] md:w-[40%] mx-auto bg-blue-200 dark:bg-slate-700  shadow-slate-400 ${EditCard ? 'block animate-slide-top overflow-hidden z-10' : 'hidden animate-slide-out delay-1000'} absolute top-24 left-[5%] md:left-[30%] shadow-sm rounded-lg `}>
                    ...
                    <>
                        ...
                        <div className={`flex flex-col w-[90%] md:w-[40%]  mx-auto bg-blue-200 dark:bg-slate-800 shadow-slate-400 ${EditCard ? 'block animate-slide-top overflow-hidden z-10' : 'hidden animate-slide-out delay-1000'} absolute top-24 md:left-[30%] left-[5%] shadow-xl rounded-sm `}>
                            <p className='text-2xl font-bold px-7 py-2'>Edit Box</p>
                            <div className='my-4 mx-auto w-[90%]' >
                                <label for="title" className='text-2xl text-semibold'>Title</label>
                                <input id='title' className='w-[100%] px-2 py-2  text-xl font-semibold rounded-md dark:text-black' type="text" value={title} onChange={(e) => { settitle(e.target.value) }} />
